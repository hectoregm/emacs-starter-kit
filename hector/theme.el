(defun color-theme-ruby ()
  ...
  (color-theme-install
   '(color-theme-ruby
     ...
     (default ((t (:inherit nil :stipple nil :background "#232323" :foreground "#E6E1DC" :inverse-video nil :box nil :strike-through nil :overline nil :underline nil :slant normal :weight normal :height 152 :width normal :foundry "unknown" :family "DejaVu Sans Mono"))))
     ...
     (font-lock-string-face ((t (:italic t :foreground "#A5C261" :slant italic))))
